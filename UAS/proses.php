    ...
    <body>
        ...
        <div id="right-panel" class="right-panel">
            ...
            <div class="content mt-3">
                <?php
                $koneksi = mysqli_connect("localhost","root","","kb");
                ...
                //---------------------------------------------------Positive Keturunan------------------------------------------------
                echo "<hr> Menghitung Diabetes Positive dan Keturunan : <br><br>";
                //menghitung diabetes Positiv dan Keturunan
                $diabetesyaketurunan1 = "SELECT COUNT(*) as yaketurunan1 FROM diabetes WHERE diabetes = 1 AND DiabetesPedigree > 1";
                $hasilyaketurunan1 = $koneksi->query($diabetesyaketurunan1);
                $hasildiabetesyaketurunan1 = mysqli_fetch_assoc($hasilyaketurunan1);
                echo "Jumlah Diabetes Positive dan Memiliki Kemungkinan Keturunan  = " . $hasildiabetesyaketurunan1['yaketurunan1'] . "<br>";

                //menghitung diabetes Positiv dan Keturunan Kecil
                $diabetesyaketurunan2 = "SELECT COUNT(*) as yaketurunan2 FROM diabetes WHERE diabetes = 1 AND DiabetesPedigree < 1";
                $hasilyaketurunan2 = $koneksi->query($diabetesyaketurunan2);
                $hasildiabetesyaketurunan2 = mysqli_fetch_assoc($hasilyaketurunan2);
                echo "Jumlah Diabetes Positive dan Memiliki Kemungkinan Keturunan Kecil  = " . $hasildiabetesyaketurunan2['yaketurunan2'] . "<br>";

                //---------------------------------------------------Negative Keturunan------------------------------------------------
                echo "<hr> Menghitung Diabetes Negative dan Keturunan : <br><br>";
                //menghitung diabetes Negative dan Keturunan
                $diabetestidakketurunan1 = "SELECT COUNT(*) as tidakketurunan1 FROM diabetes WHERE diabetes = 0 AND DiabetesPedigree > 1";
                $hasiltidakketurunan1 = $koneksi->query($diabetestidakketurunan1);
                $hasildiabetestidakketurunan1 = mysqli_fetch_assoc($hasiltidakketurunan1);
                echo "Jumlah Diabetes Negative dan Memiliki Kemungkinan Keturunan  = " . $hasildiabetestidakketurunan1['tidakketurunan1'] . "<br>";

                //menghitung diabetes Negative dan Keturunan
                $diabetestidakketurunan2 = "SELECT COUNT(*) as tidakketurunan2 FROM diabetes WHERE diabetes = 0 AND DiabetesPedigree < 1";
                $hasiltidakketurunan2 = $koneksi->query($diabetestidakketurunan2);
                $hasildiabetestidakketurunan2 = mysqli_fetch_assoc($hasiltidakketurunan2);
                echo "Jumlah Diabetes Negative dan Memiliki Kemungkinan Keturunan Kecil  = " . $hasildiabetestidakketurunan2['tidakketurunan2'] . "<br>";
                ...
                //probabilitas kelas ya pada atribut Keturunan
                $pdiabetesyaketurunan1 = $hasildiabetesyaketurunan1['yaketurunan1']/$hasildiabetesya['Positive'];
                $pdiabetesyaketurunan2 = $hasildiabetesyaketurunan2['yaketurunan2']/$hasildiabetesya['Positive'];
                //probabilitas kelas tidak pada atribut Keturunan
                $pdiabetestidakketurunan1 = $hasildiabetestidakketurunan1['tidakketurunan1']/$hasildiabetestidak['Negative'];
                $pdiabetestidakketurunan2 = $hasildiabetestidakketurunan2['tidakketurunan2']/$hasildiabetestidak['Negative'];
                ...
                echo "<br><hr>Probabilitas Positive Keturunan : <br><br>";

                echo "Probabilitas atribut Diabetes Positive Dan Mempunyai Kemungkinan Keturunan = " . $pdiabetesyaketurunan1 . "<br>";
                echo "Probabilitas atribut Diabetes Positive Dan Mempunyai Kemungkinan Keturunan Kecil = " . $pdiabetesyaketurunan2 . "<br>";

                echo "<br><hr>Probabilitas Negative Keturunan : <br><br>";

                echo "Probabilitas atribut Diabetes Negative Dan Mempunyai Kemungkinan Keturunan = " . $pdiabetestidakketurunan1 . "<br>";
                echo "Probabilitas atribut Diabetes Negative Dan Mempunyai Kemungkinan Keturunan Kecil = " . $pdiabetestidakketurunan2 . "<br>";
                ...
                if (isset($_POST['test'])) {
                  if (isset($_POST["kehamilan"])) {
                      ...
                      if (isset($_POST["plasma_glukosa"])) {
                          ...
                          if (isset($_POST["keturunan"]))
                          {
                                  $pilihan7 = $_POST["keturunan"];
                                  if ($pilihan7=="keturunan1") {
                                      $keturunanp = $pdiabetesyaketurunan1;
                                      $keturunann = $pdiabetestidakketurunan1;

                                  }elseif ($pilihan7=="keturunan2") {
                                      $keturunanp = $pdiabetesyaketurunan2;
                                      $keturunann = $pdiabetestidakketurunan2;
                      ...
                      $positif = $pdiabetesya*$kehamilanp*$plasmap*$tekananp*$tricepp*$serump*$keturunanp*$bmip*$usiap;
                      $negatif = $pdiabetestidak*$kehamilann*$plasman*$tekanann*$tricepn*$serumn*$keturunann*$bmin*$usian;

                      if ($positif>$negatif) {
                        echo "<br>Hasil Test Data<br>";
                        echo "Kriteria yang dipilih lebih banyak yang positif diabetes <br>";
                        echo "Hasil dari perhitungan positif = ".$positif."<br>";
                        echo "Hasil dari perhitungan negatif = ".$negatif."<br>";
                      }else {
                        echo "<br>Hasil Test Data<br>";
                        echo"Kriteria yang dipilih lebih banyak yang negatif diabetes<br>";
                        echo "Hasil dari perhitungan positif = ".$positif."<br>";
                        echo "Hasil dari perhitungan negatif = ".$negatif."<br>";
                      }
                }
                                     ...
                                     <div class="row form-group">
                                        <div class="col col-sm-5"><label for="kehamilan" class=" form-control-label">Pregnancies</label></div>
                                           <div class="col col-sm-6">
                                              ...
                                              <select id="kehamilan" name="kehamilan">
                                      ...
                                      <div class="row form-group">
                                          ...
                                          <div class="col col-sm-6">
                                              ...
                                              <select id="plasma_glukosa" name="plasma_glukosa">
                                      ...
                                      <div class="row form-group">
                                          ...
                                          <div class="col col-sm-6">
                                              ...
                                              <select id="tekanandarah" name="tekanandarah">
                                      ...
                                      <div class="row form-group">
                                          ...
                                          <div class="col col-sm-6">
                                            ...
                                            <select id="Triceps" name="Triceps">
                                      ...
                                      <div class="row form-group">
                                          <div class="col col-sm-5"><label for="keturunan" class=" form-control-label">Persentase Keturunan Diabetes</label></div>
                                          <div class="col col-sm-6">

                                            <select id="Serum" name="keturunan">
                                                  <option nama="keturunan1" value="keturunan1">Memiliki Kemungkinan Keturunan (>1)</option>
                                                  <option nama="keturunan2" value="keturunan2">Memiliki Kemungkinan Keturunan Kecil (<1)</option>
                                              </select>
